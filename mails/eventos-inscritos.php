	...
	<script>
		...
		if (w.performance || w.mozPerformance || w.msPerformance || w.webkitPerformance) {
			...
			AKSB = w.AKSB || {}, AKSB.q = AKSB.q || [], AKSB.mark = AKSB.mark || function(e, _) {
					...
					originlat: "0",
					clientrtt: "60",
					ghostip: "190.98.160.37",
					ipv6: false,
					pct: "10",
					clientip: "132.184.131.12",
					requestid: "4c47e",
					region: "25844",
					protocol: "h2",
					blver: 14,
															...
															<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																<span style="font-size:16px; font-family:arial,helvetica neue,helvetica,sans-serif">
																	<span style="color:#E96852">
																		<strong>¿Cuáles son las mayores oportunidades para América Latina?</strong>
																	</span><br>
													...
													<tbody>
														<tr>
															<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:left;">
																...
																<img align="center" alt="" src="https://credicorpcapitalconference.web.app/assets/img/mails/Imagen%204.png" width="370" style="max-width:507px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																<br><br><br>
